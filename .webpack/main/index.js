...
/*!*********************!*\
  !*** ./src/main.js ***!
  \*********************/
const { app, BrowserWindow, dialog, ipcMain} = __webpack_require__(/*! electron */ "electron");
const path = __webpack_require__(/*! path */ "path");
const fs = __webpack_require__(/*! fs */ "fs");
const https = __webpack_require__(/*! https */ "https");
const runCommand = __webpack_require__(/*! ./runCommand */ "./src/runCommand.js");
...
const createWindow = () => {
  ...
  const mainWindow = new BrowserWindow({
    ...
    height: 600,
    webPreferences: {
      preload: '/home/oest/Documents/ElectronConcurrentlyWebpacks/packagejson/.webpack/renderer/main_window/preload.js',
